...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "twitter:description", content: "Al Khaas GROUP  Official digital product catalogue. Browse 280+ premium confectionery products from Ferrero, Kinder, Cadbury, Mars, Nestlé, Lindt" },
      { property: "og:image", content: alkhaasLogo.url },
      { name: "twitter:image", content: alkhaasLogo.url },
      { name: "description", content: "Al Khaas GROUP  Official digital product catalogue. Browse 280+ premium confectionery products from Ferrero, Kinder, Cadbury, Mars, Nestlé, Lindt" },
      { property: "og:description", content: "Al Khaas GROUP  Official digital product catalogue. Browse 280+ premium confectionery products from Ferrero, Kinder, Cadbury, Mars, Nestlé, Lindt" },
